...
export async function generateMetadata({
  ...
  if (!league) return { title: pageTitle("Qualifying") };
  ...
  const displayName = circuit?.grand_prix_name ?? session?.name ?? "Qualifying";
  return { title: pageTitle(`Qualifying — ${displayName}`) };
}
