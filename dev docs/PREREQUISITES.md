...
- [ ] Team understands the PR flow.
- [ ] No one plans to push directly to protected branches.
...
- [ ] GitHub access works.
- [ ] GitHub `dev`, `staging`, and `prod` branches exist.
- [ ] GitHub branch protection is configured for `dev`, `staging`, and `prod`.
- [ ] GitHub PR review is required before protected branch merges.
...
- [ ] Non-production project exists for shared dev previews and the `staging` branch.
- [ ] Production project exists for the `prod` branch.
- [ ] Non-production Project URL, public key, secret key, and database password are saved.
- [ ] Production Project URL, public key, secret key, and database password are saved.
- [ ] Email Auth enabled.
- [ ] Phone Auth disabled.
...
- [ ] GitHub `dev` branch uses local Supabase by default.
- [ ] GitHub `dev` branch previews may use `f1-league-manager-nonprod`.
- [ ] GitHub `staging` branch maps to `f1-league-manager-nonprod`.
- [ ] GitHub `prod` branch maps to `f1-league-manager-prod`.
- [ ] Vercel production branch is `prod`.
