...
| Task | Status | Evidence | Outstanding / next action |
|------|--------|----------|---------------------------|
| WP3.1 scoring + role E2E (E1–E3) | Not started | | |
| WP3.2 mutation + public E2E (E4–E6) | Not started | | |
| WP3.3 Sentry dependency decision (P4) | Not started | | |
| F2 transfer double-submit follow-up filed | Not started | | |
